...
static const struct pinconf_generic_params max96792a_cfg_params[] = {
	{ "maxim,pull-strength-weak", max96792a_PINCTRL_PULL_STRENGTH_WEAK, 0 },
	{ "maxim,jitter-compensation", max96792a_PINCTRL_JITTER_COMPENSATION_EN, 0 },
	{ "maxim,gmsl-tx-a", max96792a_PINCTRL_GMSL_TX_EN_A, 0 },
	{ "maxim,gmsl-rx-a", max96792a_PINCTRL_GMSL_RX_EN_A, 0 },
	{ "maxim,gmsl-tx-id-a", max96792a_PINCTRL_GMSL_TX_ID_A, 0 },
	{ "maxim,gmsl-rx-id-a", max96792a_PINCTRL_GMSL_RX_ID_A, 0 },
	{ "maxim,gmsl-tx-b", max96792a_PINCTRL_GMSL_TX_EN_B, 0 },
	{ "maxim,gmsl-rx-b", max96792a_PINCTRL_GMSL_RX_EN_B, 0 },
	{ "maxim,gmsl-tx-id-b", max96792a_PINCTRL_GMSL_TX_ID_B, 0 },
	{ "maxim,gmsl-rx-id-b", max96792a_PINCTRL_GMSL_RX_ID_B, 0 },
};
...
{
	unsigned long config =
		pinconf_to_config_packed(max96792a_PINCTRL_INPUT_VALUE, 0);
	struct max96792a_priv *priv = gpiochip_get_data(gc);
	int ret;
...
static int max96792a_remove(struct i2c_client *client)
{
