...
static struct reg_8 ov5640_mode_1920x1080_30fps[] = {
...
static struct reg_8 ov5640_mode_2592x1944_15fps[] = {
	//<ov5640_init_setting_30fps_VGA>
	{0x3103, 0x11}, {0x3008, 0x42},
	{0x3103, 0x03}, {0x3017, 0x00}, {0x3018, 0x00},
	{0x3630, 0x36},
...
static struct reg_8 tevi_ov5640_setting_1080P_1920_1080[] = {
	//<ov5640_init_setting_30fps_VGA>
	{0x3103, 0x11}, {0x3008, 0x42},
	{0x3103, 0x03}, {0x3017, 0x00}, {0x3018, 0x00},
	{0x3630, 0x36},
...
static struct reg_8 tevi_ov5640_setting_720P_1280_720[] = {
	//<ov5640_init_setting_30fps_VGA>
	{0x3103, 0x11}, {0x3008, 0x42},
	{0x3103, 0x03}, {0x3017, 0x00}, {0x3018, 0x00},
	{0x3630, 0x36},
	...
	//<ov5640_setting_720P_1280_720 part>
...
{
	[0] = ov5640_mode_2592x1944_15fps,
	[1] = tevi_ov5640_setting_1080P_1920_1080,
	[2] = tevi_ov5640_setting_720P_1280_720,
	[3] = ov5640_mode_1920x1080_30fps,
};

static size_t mode_size[] =
{
	[0] = ARRAY_SIZE(ov5640_mode_2592x1944_15fps),
	[1] = ARRAY_SIZE(tevi_ov5640_setting_1080P_1920_1080),
	[2] = ARRAY_SIZE(tevi_ov5640_setting_720P_1280_720),
	[3] = ARRAY_SIZE(ov5640_mode_1920x1080_30fps),
};
...
static const struct camera_common_frmfmt sensor_frmfmt[] = {
	...
	{{1280, 720},__60fps, 1, 0, 2 /* number depend on dts mode list */}, 
};
